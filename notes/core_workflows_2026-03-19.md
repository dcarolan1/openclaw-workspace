...
Seven workflows that cover David's recurring operational needs across BAG, Joy Restart, Generous Java, E456, and shared functions. Each workflow defines what Aaron does, what David does, and which model handles each step.
